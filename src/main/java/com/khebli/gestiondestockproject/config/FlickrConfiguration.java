...
//    }
    ...
    public Flickr getFlickr() {
        ...
        System.out.println("set here  getaUTH -->   " + flickr.getAuth());
        System.out.println("set here token    -->   " + auth.getToken());
        System.out.println("set here  token secret  -->   " + auth.getTokenSecret());
